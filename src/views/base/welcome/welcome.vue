<template>
  <div class="welcome">
   ...
   <div class="welcome-right">
      <div class="right-top">
        <div class="shortcut">
        <div class="shortcut-title"><p class="before">快捷入口</p><p>更多>></p></div>
...
import {onMounted, ref} from "vue";
  const arr=[
    {name:'今日访问量',total:'189',mobile:'89',pc:'100',url:'../../../assets/imgs/welcome/today.png'},
    {name:'昨日访问量',total:'456',mobile:'256',pc:'200',url:'../../../assets/imgs/welcome/yesterday.png'},
    {name:'本周访问量',total:'4533',mobile:'2533',pc:'2000',url:'../../../assets/imgs/welcome/week.png'},
    {name:'本月访问量',total:'7958',mobile:'4958',pc:'3000',url:'../../../assets/imgs/welcome/mouth.png'},
  ]
  const arr2=[{name:'添加内容'},{name:'添加图片'},{name:'添加广告'},{name:'添加资讯'},]
  const tableData = [
    {
      date: 'TOP.1',
      name: '办公',
